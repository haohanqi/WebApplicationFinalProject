    ...
    <div class="productForm">
        <form id="productCU" @submit="actionProduct" v-if="!loading">
              ...
              <div class="from-group">
                ...
                <input type="text" class="form-control" id="productDescription" v-model="product.productDescription" name="productDescription" placeholder="Enter Description">
              </div>

              <div class="from-group">
                <label for="LongDescription">Product Long Description</label>
                <input type="text" class="form-control" id="LongDescription" v-model="product.LongDescription" name="LongDescription" placeholder="Enter Long Description">
              </div>

              <div class="from-group">
                <label for="productPrice">Product Price</label>
                <input type="number" class="form-control" id="productPrice" v-model="product.productPrice" name="productPrice" placeholder="Enter Price">
              </div>

               <div class="from-group">
                <label for="productPrice">Product Inventory</label>
                <input type="number" class="form-control" id="Inventory" v-model="product.Inventory" name="Inventory" placeholder="Enter Inventory">
              </div>
